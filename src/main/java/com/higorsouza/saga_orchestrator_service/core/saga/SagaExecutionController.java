...
import com.higorsouza.saga_orchestrator_service.config.exception.ValidationException;
...
import static com.higorsouza.saga_orchestrator_service.core.saga.SagaHandler.*;
...
public class SagaExecutionController {
    ...
    private boolean isEventSourceAndStatusValid(Event event, Object[] row){
        ...
        return event.getStatus().equals(source) && event.getStatus().equals(status);
    }
