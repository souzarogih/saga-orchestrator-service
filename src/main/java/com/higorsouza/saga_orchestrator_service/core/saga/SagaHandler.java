...
import static com.higorsouza.saga_orchestrator_service.core.enums.EEventSource.*;
import static com.higorsouza.saga_orchestrator_service.core.enums.ESagaStatus.*;
import static com.higorsouza.saga_orchestrator_service.core.enums.ETopics.*;
...
public final class SagaHandler {
    ...
    public static final Object[][] SAGA_HANDLER = {
            ...
            {PRODUCT_VALIDATION_SERVICE,SUCCESS,PRODUCT_VALIDATION_SUCCESS},
